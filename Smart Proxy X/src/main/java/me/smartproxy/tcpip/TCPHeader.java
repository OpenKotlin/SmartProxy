...
public class TCPHeader {
	...
	static final short offset_src_port = 0; // 16????
	static final short offset_dest_port = 2; // 16?????
	static final int offset_seq = 4; // 32????
	static final int offset_ack = 8; // 32????
	static final byte offset_lenres = 12; // 4?????/4????
	static final byte offset_flag = 13; // 6????
	static final short offset_win = 14; // 16?????
	static final short offset_crc = 16; // 16????
	static final short offset_urp = 18; // 16????????
